...
var statisticsChartElem = document.getElementById('statisticsChart');
if (statisticsChartElem) {
    var ctx = statisticsChartElem.getContext('2d');
...
// Chart.js - Daily Sales Chart
var dailySalesChartElem = document.getElementById('dailySalesChart');
if (dailySalesChartElem) {
    var dailySalesChartCtx = dailySalesChartElem.getContext('2d');
    var myDailySalesChart = new Chart(dailySalesChartCtx, {
        type: 'line',
        data: {
            labels: ["January",
                "February",
