...
!function (t) {
    ...
    function e(e, n, a) {
        var o = {
            content: {
                message: "Ucapan Selamat Datang Kembali!", // Message updated here
                title: n.title ? n.title : "Selamat Datang", // Optional title
                icon: n.icon ? n.icon : "",
                url: n.url ? n.url : "#",
        ...
        t.extend(e.prototype, {
            ...
            bind: function () {
                ...
                this.$ele.find('[data-notify="dismiss"]').on("click", function () {
                    ...
                    this.settings.delay > 0 && (s.$ele.data("notify-delay", s.settings.delay),
                        setInterval(function () {
                            ...
                            t <= -s.settings.timer && (clearInterval(s), s.close())
                        }, s.settings.timer))
            },
            close: function () {
                var s = this,
